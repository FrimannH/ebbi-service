...
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Product Variety", "Product variety", "How important do you consider the following factors to be for energy providers in general", "", 4, 0);
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Customer service", "Customer service", "How important do you consider the following factors to be for energy providers in general", "", 4, 0);
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Reliability", "Reliability", "How important do you consider the following factors to be for energy providers in general", "", 4, 0);
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Environmental policy", "Environmental policy", "How important do you consider the following factors to be for energy providers in general", "", 4, 0);
...
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Gender", "What is your gender", "What is your gender", "", 5, 0);
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Age", "How old are you", "How old are you", "", 5, 0);
...
INSERT INTO Questions (question_name, question_short_description, question_long_description, question_text, question_type, question_score_formulation) VALUES("Household income", "Household income", "What is your total household income", "", 5, 0);
